...
import { Bus, ChevronLeft, Eye, EyeOff, KeyRound, Phone, Users } from 'lucide-react';
...
const CoordinatorLogin = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // If successful, navigate to coordinator dashboard
      ...
      // Show option to reset password after 3 failed attempts
  ...
  const handleResetPassword = async (e: React.FormEvent) => {
    ...
    try {
      // In a real app, you'd send the OTP and new password to the server
              ...
              <form onSubmit={handleSubmit}>
                ...
                <CardFooter className="flex flex-col space-y-4">
                  ...
                  <div className="text-center text-sm">
                    <div className="mb-2">
                      Note: Coordinator accounts are created by Admins
                    </div>
                    <div className="flex items-center justify-center gap-1 text-purple-600">
                      <Bus className="h-4 w-4" />
                      <span>Campus Bus Management System</span>
                    </div>
                  </div>
                </CardFooter>
              </form>
