...
interface Alert {
  id: string;
  type: 'emergency' | 'complaint' | 'system';
  message: string;
  studentName?: string;
  ...
  const [alerts, setAlerts] = useState<Alert[]>([
    {
      id: 'alert1',
      type: 'emergency',
      message: 'Student reported being left at the bus stop.',
    ...
    },
    {
      id: 'alert2',
      type: 'system',
      message: 'Route change due to road construction near Hubli Central.',
                ...
                <CardContent className="p-5">
                  <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <h3 className="font-semibold">
                          {alert.type === 'emergency' ? 'Emergency Alert' : 
                           alert.type === 'complaint' ? 'New Complaint' : 
                           'System Notification'}
                        </h3>
                        ...
                        <div className="flex items-center gap-4 text-sm">
                          ...
                          {alert.studentContact && (
                            <div className="flex items-center gap-1">
                              ...
                              <span>{alert.studentContact}</span>
                            </div>
                          )}
                        </div>
                      )}
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      {alert.status === 'new' && alert.type === 'emergency' && alert.studentContact && (
                        <Button 
                          size="sm" 
                          variant="default"
                        >
